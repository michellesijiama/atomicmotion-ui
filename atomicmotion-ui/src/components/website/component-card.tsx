...
export function ComponentCard({ component }: ComponentCardProps) {
  ...
  const previewClassName =
    "relative aspect-[4/5] overflow-hidden rounded-[15px] bg-white/70";

  if (!Preview) {
    return (
      <div className={cardClassName}>
        <div className={previewClassName}>
          <div className="flex size-full items-center justify-center bg-[var(--jitter-surface)] text-body text-[var(--jitter-gray-400)]">
            Coming soon
          </div>
        </div>
