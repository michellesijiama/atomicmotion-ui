...
| <img src="public/previews/frosted-event-card.png" width="160"> | **Frosted Event Card** — eight event cards on a ring inside a phone lying on its side: swipe, and they follow your finger and snap one page at a time, the neighbours turning away like cover flow; each card is a heat-map field with circles, ellipses, arcs and coils painted onto it as heat, every shape its own halo-to-core gradient, in palettes borrowed from painters — most cohesive, Matisse and Delaunay loud | Card | — | [`frosted-event-card.tsx`](components/card/frosted-event-card/frosted-event-card.tsx) |
