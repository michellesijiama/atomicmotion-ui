...
| <img src="public/previews/frosted-event-card.png" width="160"> | **Frosted Event Card** — a dark event card whose picture is a frosted, grainy bloom of a pagoda fading into black; a white date badge, a glass share button, a serif title, and a sign-up pill that springs into a lavender "You're on the list" | Card | — | [`frosted-event-card.tsx`](components/card/frosted-event-card/frosted-event-card.tsx) |
