...
const checks = [
  ...
  ["component renders pause and keyboard controls", files.component.includes('aria-label="Pause"') && files.component.includes("Keyboard")],
  ...
  ["component animates glow while listening", files.component.includes("activeListeningPulsePattern") && files.component.includes("repeat: Infinity") && files.component.includes("active={true}")],
  ...
  ["component uses compact bottom control buttons", files.component.includes("m3BottomControlButtonClassName") && files.component.includes("h-8 w-[43px]")],
  ["component keeps Gemini Live always listening", files.component.includes("Listening...") && !files.component.includes("Live is paused") && !files.component.includes("setIsListening")],
  ["component removes bottom control hover effects", !files.component.includes("hover:bg-white/10") && !files.component.includes("group-hover:opacity-100") && !files.component.includes("Switch to text mode")],
  ...
  ["component supports loop preview", files.component.includes("loop = false") && files.component.includes('loop && "h-[300px] w-[585px]"')],
