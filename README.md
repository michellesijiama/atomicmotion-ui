...
| <img src="public/previews/glass-tab-menu.png" width="160"> | **Glass Tab Menu** — a frosted pink-lavender glass tab bar whose blush pill slides between Shop and Features; Shop unfolds a frosted list with a row-hover pill that slides between rows, Features unfolds a glossy media card | Navigation | — | [`glass-tab-menu.tsx`](components/navigation/glass-tab-menu/glass-tab-menu.tsx) |
